...
{\huge Bing O'Dowd} & \href{https://github.com/bodowd/}{github.com/bodowd}  \& \href{https://gitlab.com/bodowd/}{gitlab.com/bodowd} \\ Email : \href{mailto:odowd.bing@gmail.com}{odowd.bing@gmail.com} &  \href{https://www.linkedin.com/in/bing-o-dowd-76a7579b/}{linkedin.com/in/bing-o-dowd}
\end{tabular*}
% \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
...
\section{Experience}
 ...
 {Data Scientist}{October 2020 - Present}
   \resumeItemListStart
   	\resumeItem{Built data processing pipeline in order to perform first ever combined analysis}
   	...
   	\resumeItem{Advanced projects with project-specific data analysis and models}
 ...
 \resumeSubheading
 {Developer}{}
 {Online job board side project -- chirole.com}{2019}
  \resumeItemListStart
	\resumeItem{Built online job board for computational jobs in life science companies}
	{Used Python/Flask for backend, Bootstrap, CSS, and HTML for front end, Postgres and SQLalchemy for the database, and deployed and hosted the app on Linode}
 ...
 {PostDoc}{October 2018 - October 2020}
  ...
  \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Data Scientist Intern, Cheminformatics}{March - August 2017}
      \resumeItemListStart
...
\section{Skills}
%  \resumeSubHeadingListStart
    \textbullet{ Python, RDKit, Pandas, NumPy, Scikit-learn, PyTorch, SQL, Unix, git, statistics, machine learning, deep learning, organic chemistry, biochemistry, drug discovery, cheminformatics}\\
%  \resumeSubHeadingListEnd
